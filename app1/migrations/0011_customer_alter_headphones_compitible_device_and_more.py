# Generated by Django 4.0.3 on 2022-04-27 07:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('app1', '0010_headphones_alter_printers_manufacturer_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='Compitible_device',
            field=models.CharField(default='Audio Player , Laptop, Mobile, Tablet', max_length=40),
        ),
        migrations.CreateModel(
            name='OrderPlaced',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.laptops')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
